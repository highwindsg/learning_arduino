...
const char* ssid = "BTIA_CAY1SGP";
const char* password = "11223344sgp";
...
void loop() {
  ...
  // NOTE: We have the cmd=RELOAD_PHOTOCELL command becasue we need a way
  ...
  client.println("<a href=\"?cmd=TURN_ON_LED\"><button>Turn Off </button></a>");
  client.println("<a href=\"?cmd=TURN_OFF_LED\"><button>Turn On </button></a><br />");
